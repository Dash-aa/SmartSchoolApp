 ...
 * Перевіряють коректність отримання списку актуальних оголошень.
 */
class AnnouncementServiceTest {

  /**
   * Перевіряє, що метод повертає непорожній список оголошень
   * з валідними заголовками та текстом.
   */
  @Test
